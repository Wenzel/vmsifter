...
static const char* OPTS = "hDS:m:p:e:";
static const struct option LONG_OPTS[] =
    {
        ...
        {"mode", required_argument, NULL, 'e'}, // 32/64
        {NULL, 0, NULL, 0}
    };
// default config
...
static xed_state_t xed_state = {0};
static char* mode = "64";
...
int main(int argc, char** argv)
{
    ...
    if (!strcmp(mode, "32"))
        xed_state_init2(&xed_state, XED_MACHINE_MODE_LEGACY_32, XED_ADDRESS_WIDTH_32b);
    else if (!strcmp(mode, "64"))
